...
export type Database = {
  public: {
    Tables: {
      ...
      event_market_outcome_rules: {
        Row: {
          created_at: string
          outcome_code: string
          report_type: Database["public"]["Enums"]["event_report_type"]
        ...
        Relationships: [
          {
            foreignKeyName: "event_market_outcome_rules_template_code_fkey"
      ...
      event_report_media: {
        ...
        Relationships: [
          {
            foreignKeyName: "event_report_media_media_asset_id_fkey"
          ...
          {
            foreignKeyName: "event_report_media_report_id_fkey"
            columns: ["report_id"]
            isOneToOne: false
      ...
      event_report_votes: {
        Row: {
          created_at: string
          decision: Database["public"]["Enums"]["event_vote_decision"]
          id: string
          report_id: string
          user_id: string
        }
        ...
        Relationships: [
          {
            foreignKeyName: "event_report_votes_report_id_fkey"
            columns: ["report_id"]
            isOneToOne: false
            referencedRelation: "event_reports"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "event_report_votes_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      event_reports: {
        ...
        Relationships: [
          {
            foreignKeyName: "event_reports_author_user_id_fkey"
          ...
          {
            foreignKeyName: "event_reports_market_season_fk"
            columns: ["market_id", "season_id"]
            isOneToOne: false
            referencedRelation: "markets"
            referencedColumns: ["id", "season_id"]
          },
          {
            foreignKeyName: "event_reports_outcome_market_fk"
            columns: ["outcome_id", "market_id"]
            isOneToOne: false
            referencedRelation: "market_outcomes"
            referencedColumns: ["id", "market_id"]
          ...
          {
            foreignKeyName: "event_reports_season_id_fkey"
            columns: ["season_id"]
            isOneToOne: false
            referencedRelation: "seasons"
            referencedColumns: ["id"]
      ...
      season_invitations: {
        Row: {
          ...
          proposed_subject_key:
            | Database["public"]["Enums"]["subject_key"]
            | null
          season_id: string
    ...
    Functions: {
      ...
      ensure_single_room_access: { Args: never; Returns: string }
      ...
      single_room_id: { Args: never; Returns: string }
      submit_event_report: {
        Args: {
          p_idempotency_key: string
          p_market_id: string
          ...
          p_outcome_id: string
          p_report_type: Database["public"]["Enums"]["event_report_type"]
        }
        Returns: Json
      }
      suspend_market: {
      ...
      vote_event_report: {
        Args: {
          p_decision: Database["public"]["Enums"]["event_vote_decision"]
          p_report_id: string
        }
        Returns: Json
      }
